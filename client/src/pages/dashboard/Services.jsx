...
export default function Services() {
  ...
  return <div>
    <div className="mb-7 flex flex-col justify-between gap-4 sm:flex-row sm:items-center"><div><h2 className="text-2xl font-bold">Your service workspace</h2><p className="mt-1 text-sm text-muted">Track progress and manage priorities across your subscription.</p></div><Button onClick={() => setRequestOpen(true)}><Plus size={16}/>New request</Button></div>
