...
const PRIORITIES = [
  { value: "low", label: "Low", dot: "bg-muted", active: "border-border bg-surface-raised text-muted" },
  { value: "medium", label: "Medium", dot: "bg-primary", active: "border-primary/60 bg-primary/10 text-primary" },
