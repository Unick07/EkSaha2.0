...
export default function Users() {
  ...
  return <div>
    <div className="mb-7 flex flex-col justify-between gap-4 sm:flex-row sm:items-center"><div><h2 className="text-2xl font-bold">User management</h2><p className="mt-1 text-sm text-slate-500">Manage customer accounts, access and assigned plans. Internal team access is managed on the Team page.</p></div><Button onClick={() => setEditing({})}><Plus size={16}/>Add user</Button></div>
