  ...
  return <footer className="border-t border-border bg-surface-raised">
    <div className="container-shell py-16">
      <div className="grid gap-12 lg:grid-cols-[1.3fr_.7fr_.7fr_1.2fr]">
        <div><div className="flex items-center gap-2.5 font-extrabold"><span className="grid size-9 place-items-center rounded-xl bg-primary text-primary-foreground">E</span>EkSaha</div><p className="mt-5 max-w-xs text-sm leading-6 text-muted">The flexible digital and IT team built for ambitious small businesses.</p><div className="mt-6 flex gap-2"><a className="icon-button size-10" href="#"><Linkedin size={17} /></a><a className="icon-button size-10" href="#"><Github size={17} /></a></div></div>
